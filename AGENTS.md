...
- Backend: [Backend Guide](draco-nodejs/backend/AGENTS.md)
- Frontend (Next.js): [Frontend Guide](draco-nodejs/frontend-next/AGENTS.md)
- Shared Schemas & API Client: [Shared Guide](draco-nodejs/shared/AGENTS.md)
