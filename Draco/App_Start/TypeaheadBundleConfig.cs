...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(SportsManager.App_Start.TypeaheadBundleConfig), "RegisterBundles")]

namespace SportsManager.App_Start
{
	public class TypeaheadBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new StyleBundle("~/Content/typeahead").Include(
