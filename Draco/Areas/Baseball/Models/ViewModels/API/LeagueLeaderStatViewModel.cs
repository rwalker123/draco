...
namespace SportsManager.Baseball.ViewModels.API
{
	...
	/// </summary>
	public class LeagueLeaderStatViewModel
	{
		...
		public LeagueLeaderStatViewModel()
		{
		}

		public LeagueLeaderStatViewModel(int tieCount, double fieldTotal)
		{
			m_fieldName = "TIE";
			m_playerId = 0;
			m_teamId = 0;
		...
		public LeagueLeaderStatViewModel(string fieldName, long playerId, long teamId, double fieldTotal)
		{
        ...
        public ContactNameViewModel PlayerName
        {
            get;
            set;
        }
