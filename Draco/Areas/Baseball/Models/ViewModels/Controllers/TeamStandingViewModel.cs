...
namespace SportsManager.Baseball.ViewModels.Controllers
{
	...
	/// </summary>
	public class TeamStandingViewModel : IComparable
	{
        ...
        public TeamStandingViewModel(TeamStandingViewModel copyFrom)
        {
		...
		public TeamStandingViewModel(long teamId, long divisionId, String teamName)
		{
			m_teamId = teamId;
		...
		{
			TeamStandingViewModel t = (TeamStandingViewModel)o;
		...
		public void AddGameResult(bool homeTeam, TeamStandingViewModel opponent, int homeScore, int awayScore, int gameStatus)
		{
