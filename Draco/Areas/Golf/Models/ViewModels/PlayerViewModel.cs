...
namespace SportsManager.Golf.ViewModels
{
    ...
    {
        public PlayerViewModel(GolfRoster rosterPlayer)
        {
        ...
        {
            var scores = DataAccess.Golf.GolfScores.GetGolfScores(ContactId);
            ...
            int numScoresToUse = GolfScores.GetLowestScoresToUse(PlayerScores.Count());
