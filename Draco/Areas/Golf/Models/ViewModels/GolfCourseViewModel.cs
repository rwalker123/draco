...
namespace SportsManager.Golf.ViewModels
{
	...
	{
		public GolfCourseViewModel(long accountId)
		{
			AccountId = accountId;
		...
		public void AddTees()
		{
			IEnumerable<GolfTeeInformation> teeInfos = DataAccess.Golf.GolfCourses.GetTeesForCourse(CourseId);
		...
		public static GolfCourseViewModel GetCourseViewModel(long accountId, GolfCourse course)
		{
