...
namespace SportsManager.Golf.ViewModels
{
	public class GolfScoreViewModel
	{
		...
		public GolfScoreViewModel(GolfScore golfScore, GolfRoster player)
			: this(player)
		{
		...
		public GolfScoreViewModel(GolfRoster player, bool addAsAbsent = false)
		{
		...
		public GolfScoreViewModel(GolfRoster player, GolfMatch forMatch, GolfTeeInformation teeInfo, int numHoles)
			: this(player)
		{
			...
			GolfCourse = DataAccess.Golf.GolfCourses.GetCourse(CourseId);
			GolfTeeInformation = teeInfo;

			StartIndex = GolfScore.GetStartIndex(GolfScores.CalculateHandicapIndexOnDate(player.Contact.Id, forMatch.MatchDate, true), IsFemale);
		...
		internal static GolfScore GolfScoreFromViewModel(GolfScoreViewModel x)
		{
			GolfRoster rp = DataAccess.Golf.GolfRosters.GetRosterPlayer(x.PlayerId);
