...
{
    public class LeagueMatchResultsViewModel : AccountViewModel
    {
        public LeagueMatchResultsViewModel(DBController c, long accountId, long flightId, DateTime matchDate)
            : base(c, accountId)
        {
        ...
        private void Initialize(long accountId, long flightId, DateTime matchDate)
        {
            ...
            IEnumerable<GolfMatch> matches = Controller.GetCompletedMatches(flightId, MatchDate);
        ...
        private void ProcessMatches(IEnumerable<MatchResultsViewModel> matchResults)
        {
            ...
            foreach (var matchResult in matchResults)
            {
                ...
                {
                    teamScores.Add(new TeamScore(matchResult.Team1Name, matchResult.Team1Id, matchResult.Team1MatchPoints, matchResult.Team1NetScore));
                    teamScores.Add(new TeamScore(matchResult.Team2Name, matchResult.Team2Id, matchResult.Team2MatchPoints, matchResult.Team2NetScore));
                }
    ...
    {
        public TeamScore(string teamName, long teamId, double matchPoints, int netScore)
        {
            TeamId = teamId;
            TeamName = teamName;
    ...
    public class PlayoffResult
    {
        public PlayoffResult(MatchResultsViewModel matchResult, bool isTeam1Winner)
        {
            ...
            Team1 = matchResult.Team1Name;
            Team2 = matchResult.Team2Name;
        }
