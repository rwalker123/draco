...
export class RepositoryFactory {
  ...
  static getWelcomeMessageRepository(): IWelcomeMessageRepository {
    if (!this.welcomeMessageRepository) {
      this.welcomeMessageRepository = new PrismaWelcomeMessageRepository(prisma);
    }
    return this.welcomeMessageRepository;
  }
  ...
  static getSchedulerApplyAuditLogRepository(): ISchedulerApplyAuditLogRepository {
    if (!this.schedulerApplyAuditLogRepository) {
  ...
  static getLiveScoringRepository(): ILiveScoringRepository {
    if (!this.liveScoringRepository) {
      this.liveScoringRepository = new PrismaLiveScoringRepository(prisma);
    }
    return this.liveScoringRepository;
  }

  static getIndividualLiveScoringRepository(): IIndividualLiveScoringRepository {
    if (!this.individualLiveScoringRepository) {
