...
import allTimeTeamStatsRouter from './routes/all-time-team-stats.js';
...
app.use('/api/accounts/:accountId/statistics/all-time/teams', allTimeTeamStatsRouter);
...
app.use('/api/accounts/:accountId/games', baseballLiveScoringRouter);
