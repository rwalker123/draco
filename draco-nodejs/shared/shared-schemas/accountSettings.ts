...
export const ACCOUNT_SETTING_DEFINITIONS: AccountSettingDefinition[] = [
  ...
  booleanSetting({
    key: 'EnableTeamEmail',
    label: 'Enable Team Email',
    description:
      'Allows team administrators to compose emails to their team roster and view email history.',
    groupId: AccountSettingGroupEnum.enum.teamPages,
    groupLabel: 'Team Pages',
    sortOrder: 15,
    defaultValue: true,
    componentGates: [
      {
        id: 'team.emailCompose.button',
        type: 'widget',
        displayName: 'Email Team Button',
        expectedValue: true,
      },
      {
        id: 'team.emailHistory.button',
        type: 'widget',
        displayName: 'Email History Button',
        expectedValue: true,
      },
      {
        id: 'team.emailCompose.page',
        type: 'page',
        displayName: 'Team Email Compose Page',
        hiddenBehavior: 'notFound',
        expectedValue: true,
      },
      {
        id: 'team.emailHistory.page',
        type: 'page',
        displayName: 'Team Email History Page',
        hiddenBehavior: 'notFound',
        expectedValue: true,
      },
    ],
