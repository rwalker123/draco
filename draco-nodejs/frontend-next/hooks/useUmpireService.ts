...
export function useUmpireService(accountId: string): UmpireService {
  ...
  const listUmpires = useCallback<UmpireService['listUmpires']>(
    async (params: ListUmpireParams = {}) => {
  ...
  const createUmpire = useCallback<UmpireService['createUmpire']>(
    async (payload) => {
      try {
  ...
  const deleteUmpire = useCallback<UmpireService['deleteUmpire']>(
    async (umpireId) => {
      try {
