...
export function useGolfTeams(accountId: string): GolfTeamService {
  ...
  const listTeams: GolfTeamService['listTeams'] = async (seasonId) => {
    try {
  ...
  const listTeamsForFlight: GolfTeamService['listTeamsForFlight'] = async (flightId) => {
    try {
  ...
  const getTeam: GolfTeamService['getTeam'] = async (seasonId, teamSeasonId) => {
    try {
  ...
  const createTeam: GolfTeamService['createTeam'] = async (flightId, payload) => {
    try {
  ...
  const updateTeam: GolfTeamService['updateTeam'] = async (seasonId, teamSeasonId, payload) => {
    try {
  ...
  const deleteTeam: GolfTeamService['deleteTeam'] = async (seasonId, teamSeasonId) => {
    try {
