...
interface TwitterPostSettingsWidgetProps {
...
export const TwitterPostSettingsWidget: React.FC<TwitterPostSettingsWidgetProps> = ({
  ...
  return (
    <WidgetShell
      ...
      subtitle="Share announcements, game results, and workout updates automatically with your Twitter followers."
      accent="info"
    >
...
export default TwitterPostSettingsWidget;
